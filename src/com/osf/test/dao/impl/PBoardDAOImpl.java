...
//		Map<String,String> pBoard = new HashMap<>();
//		pBoard.put("pb_title", "이것도 참 버릇이다.");
//		pBoard.put("pb_content", "전반적으로 지금 하고 있는거 이해 되는거 맞죠?");
//		pBoard.put("pb_file_path", "테스트파일명.jpg");
//		pBoard.put("pb_real_path", "d:\\study\\webcontent\\123132.jpg");
//		System.out.println(pbdao.insertPBoard(pBoard));
